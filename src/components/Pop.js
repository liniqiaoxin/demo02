...
class Lists extends React.Component {
  ...
  render() {
    ...
    return <ul style={{ display: "flex",listStyleType: "none",flexDirection: "row",margin: 0,padding: 0}}>{children}</ul>;
  }
}
...
class List extends React.Component {
  render() {
    ...
    return (
      <div style={{boxSizing: "border-box", width: "200px", padding: "24px",paddingRight: "10px",
                    marginTop: "10px", marginBottom: "10px", backgroundColor: "rgb(235, 235, 235)"}}>
        <div style={{paddingRight: "24px"}}>
          ...
          <h4 style={{ display: "flex",flexDirection: "row", height: "36px",justifyContent: "center"}}>
              {list.owner.login} 
          </h4>
        </div>
        ...
        <div>
          <i
            ...
            style={{display: "inline-flex",width: "16px",justifyContent: "center", color: "orange" }}
          />
            {list.owner.login}
        </div>
        <div>
          <i
            ...
            style={{display: "inline-flex",width: "16px",justifyContent: "center", color: "yellow" }}
          />
        ...
        <div>
          <i
            ...
            style={{display: "inline-flex",width: "16px",
        ...
        <div>
          <i
            ...
            style={{display: "inline-flex",width: "16px",
            justifyContent: "center", color: "pink" }}
          />
